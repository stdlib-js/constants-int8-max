...
-   [`@stdlib/constants/int8/min`][@stdlib/constants/int8/min]: minimum signed 8-bit integer.
...
[test-image]: https://github.com/stdlib-js/constants-int8-max/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/constants-int8-max/actions/workflows/test.yml
